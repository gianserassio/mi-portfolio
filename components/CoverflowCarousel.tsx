    ...
    >
      <div className="relative">
        <div
          ...
          className="cursor-grab overflow-hidden py-10 outline-none focus-visible:ring-2 focus-visible:ring-[#E87878] active:cursor-grabbing"
          style={{
          ...
          >
            {slides.map((slide, index) => (
              <div
                ...
                className="absolute left-1/2 top-0 aspect-square overflow-hidden rounded-2xl bg-[#150000] border border-[#3c0000] shadow-xl will-change-transform"
        ...
        {showNavigation && (
          <>
            <button
              ...
              onClick={() => nudge(-1)}
              className="absolute left-3 top-1/2 z-[200] -translate-y-1/2 rounded-full bg-[#0d0000]/70 p-2 text-white backdrop-blur transition hover:bg-[#0d0000]"
            >
              <ChevronLeft />
            </button>
            <button
              ...
              onClick={() => nudge(1)}
              className="absolute right-3 top-1/2 z-[200] -translate-y-1/2 rounded-full bg-[#0d0000]/70 p-2 text-white backdrop-blur transition hover:bg-[#0d0000]"
            >
              <ChevronRight />
            </button>
          </>
      ...
      {showCaption && active?.title && (
        ...
        >
          ...
          {active.subtitle && (
            <p className="mt-1 text-[13px] text-[#A48888]">{active.subtitle}</p>
          )}
        </div>
      )}
        ...
        <div className="mt-6 flex items-center justify-center gap-2">
          {slides.map((_, index) => (
            <button
              ...
              onClick={() => goTo(index)}
              className={`size-2 rounded-full bg-[#E87878] transition-opacity ${
